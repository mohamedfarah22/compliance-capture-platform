-- ─── Customer Search RPCs ─────────────────────────────────────────────────────
--
-- Two SECURITY DEFINER RPCs in the public schema that search ttr.parties across
-- completed transactions for the current reporting entity, deduplicated by
-- identity, returning the most recent record per unique person/company.
